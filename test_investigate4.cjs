...
async function main() {
  console.log("--- Testing t11.Field_007 > 0 AND t11.Field_036 = '12' for OpCode 12 in 1405 ---");
  const items = await query(`
    ...
    WHERE t10.Field_008 >= '2026-03-21T00:00:00.000Z' AND t10.Field_008 <= '2026-08-08T23:59:59.000Z'
      AND (
        (t10.Field_009 = '12' AND t11.Field_036 = '12' AND t11.Field_007 > 0)
        OR
  ...
  items.filter(i => targets.some(t => i.ItemName === t)).forEach(i => console.log(i));
}
