...
async function run() {
  const query = `
    ...
    WHERE t10.Field_008 >= '2025-03-21T00:00:00.000Z' AND t10.Field_008 <= '2026-03-20T23:59:59.000Z'
      AND (t10.Field_009 = '12' OR t10.Field_009 = '13')
      AND t11.Field_007 > 0
      AND t11.Field_007 > t11.Field_006 * 10
  ...
  try {
    ...
    console.log(data.find(r => r.ItemName === 'POY 250/48 سفید'));
    console.log(data.find(r => r.ItemName === 'POY500/96 سفید'));
  } catch (e) {
