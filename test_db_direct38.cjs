...
async function run() {
  const query = `
    ...
    WHERE t10.Field_008 >= '2025-03-21T00:00:00.000Z' AND t10.Field_008 <= '2025-08-22T23:59:59.000Z'
      ...
      AND t11.Field_007 > 0
      AND EXISTS (
        SELECT 1 FROM STR_TBL_010 t10_2 
        WHERE t10_2.Field_004 = t10.Field_004 AND t10_2.Field_005 = t10.Field_005 AND t10_2.Field_009 = '26'
      )
  ...
  try {
    ...
    // Also specifically look at POY 250/48 Sefid
    const poy250 = res.data.data.find(r => r.ItemName === 'POY 250/48 سفید');
    console.log('POY 250/48 سفید:', poy250);
  } catch (e) {
