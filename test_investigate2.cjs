...
async function main() {
  console.log("--- Checking Field_036 in STR_TBL_011 for OpCode 12 in 1405 ---");
  const res = await query(`
    SELECT t11.Field_036, COUNT(*) as Cnt, SUM(t11.Field_006) as TotalQty, SUM(t11.Field_007) as TotalAmt
