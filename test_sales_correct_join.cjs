...
async function run() {
    // Corrected SQL adding t11.Field_036 = t10.Field_009
    const sql = `
        SELECT 
    ...
    try {
        ...
        console.log("Corrected items count:", data.length);
        ...
        console.log("Calculated Net Sales with Correct Join:", totalA);
