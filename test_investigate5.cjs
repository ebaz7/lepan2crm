...
async function main() {
  console.log("--- Inspecting rows for POY 160/48 سفید ---");
  const rows = await query(`
    SELECT 
      t10.Field_001, t10.Field_006, t10.Field_008, t10.Field_009, t11.Field_036,
      t11.Field_006 as Qty, t11.Field_007 as Amt, t11.Field_009 as NetAmt
    ...
    WHERE t10.Field_008 >= '2026-03-21T00:00:00.000Z' AND t10.Field_008 <= '2026-08-08T23:59:59.000Z'
      ...
      AND COALESCE(t22.Field_004, t02.Field_003) = N'POY 160/48 سفید'
  `);
  console.log(rows);
}
