...
async function main() {
  console.log("--- Testing 1404 date range (doc2.pdf) with unit price filter ---");
  const items = await query(`
    ...
    WHERE t10.Field_008 >= '2025-03-21T00:00:00.000Z' AND t10.Field_008 <= '2025-08-08T23:59:59.000Z'
      AND (
  ...
  items.filter(i => i.ItemName && i.ItemName.includes('POY')).forEach(i => console.log(i));
}
